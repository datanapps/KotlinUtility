...
import com.datanapps.kotlin_utility.loggers.getClassNameMethodNameAndLineNumber
...
* */
    ...
    * */
    ...
    fun e(throwable: Throwable?) {
        if (BuildConfig.DEBUG) {
            android.util.Log.e(TAG, validateString(throwable?.message), throwable)
        }
    }
...
* */
    ...
    * */
    ...
    private fun validateString(msg: String?) = when {
        ...
        else -> getClassNameMethodNameAndLineNumber().plus(msg)
    }
